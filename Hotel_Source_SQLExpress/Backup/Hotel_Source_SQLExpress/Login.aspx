...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="height: 243px" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="3" style="background-position: center center; background-image: url(images/green_banner.jpg);
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox1" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="8pt"
                                Width="100px" ontextchanged="TextBox1_TextChanged"></asp:TextBox></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox2" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="8pt"
                                TextMode="Password" Width="100px" ontextchanged="TextBox2_TextChanged"></asp:TextBox>
                        </td>
                        <td>
