...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" height="100%" style="background-color: buttonface" width="100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox4" runat="server" Enabled="False" Font-Bold="True" Font-Names="Tahoma"
                    Font-Size="8pt"></asp:TextBox>
        ...
        <tr>
            ...
            <td style="height: 26px">
                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="ثبت تغییرات"
                    Width="85px" Font-Bold="True" Font-Names="Tahoma" />
            </td>
            <td style="height: 26px">
            </td>
        </tr>
